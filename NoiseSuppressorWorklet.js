...
let createRNNWasmModuleSync = (() => {
  // var _scriptDir = import.meta.url;
  var _scriptDir = "./";

  return function (createRNNWasmModuleSync) {
    createRNNWasmModuleSync = createRNNWasmModuleSync || {};

    var Module =
      typeof createRNNWasmModuleSync != "undefined"
...
class NoiseSuppressorWorklet extends AudioWorkletProcessor {
  ...
  process(inputs, outputs) {
    ...
    const outData = outputs[0][0]; // left
    const outData2 = outputs[0][1]; // right
